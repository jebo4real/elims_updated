...
2017-04-27 03:03:01	CREATE TABLE IF NOT EXISTS report_config (
...
2017-04-27 03:03:02	
;
2017-04-27 03:03:02	CREATE TABLE IF NOT EXISTS report_config (
  report_id int(10) unsigned NOT NULL auto_increment,
  header varchar(500) NOT NULL default '',
  footer varchar(500) NOT NULL default '',
  margins varchar(45) NOT NULL default '',
...
'0', '1', '1', '0', '1', '0', '9999019', '0', 9999019, 1);
2017-04-27 03:03:02	;
2018-11-08 05:09:41	ALTER TABLE `specimen` MODIFY COLUMN `date_collected` datetime default '0000-00-00 00:00:00';
2018-11-08 05:09:41	
...
2018-11-08 05:09:41	;
2019-09-08 15:13:30	UPDATE lab_config SET s_addl=1 WHERE lab_config_id=127
2019-09-08 15:13:30	UPDATE lab_config SET sid=2 WHERE lab_config_id=127
2019-09-08 15:13:30	UPDATE lab_config SET dformat='d-m-Y' WHERE lab_config_id=127
2019-09-08 15:13:30	UPDATE lab_config SET dnum_reset=1 WHERE lab_config_id=127
2019-09-08 15:13:30	UPDATE lab_config SET doctor=1 WHERE lab_config_id=127
2019-09-10 14:25:59	UPDATE lab_config SET name='Testlab1', location='GT', admin_user_id=53, id_mode=1 WHERE lab_config_id=127
2019-09-10 14:27:10	UPDATE lab_config SET daily_num=1 WHERE lab_config_id=127
2019-09-10 14:27:11	UPDATE lab_config SET age=11 WHERE lab_config_id=127
2019-09-10 14:27:17	UPDATE lab_config SET daily_num=1 WHERE lab_config_id=127
2019-09-10 14:27:17	UPDATE lab_config SET age=1 WHERE lab_config_id=127
2019-09-10 14:42:40	UPDATE lab_config SET site_choice_enabled='1' WHERE lab_config_id='127'
2019-09-10 14:52:07	UPDATE lab_config SET pid=4 WHERE lab_config_id=127
2019-09-10 14:52:07	UPDATE lab_config SET comm=1 WHERE lab_config_id=127
2019-09-10 14:52:07	UPDATE lab_config SET dformat='d-m-Y' WHERE lab_config_id=127
2019-09-10 14:52:07	UPDATE lab_config SET dnum_reset=1 WHERE lab_config_id=127
2019-09-10 14:52:07	UPDATE lab_config SET doctor=1 WHERE lab_config_id=127
