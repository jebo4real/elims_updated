...
$LANG_ARRAY = array ( 
	...
	"home" => array ( 
		"TITLE" => "Home", 
		"WELCOME" => "Welcome", 
		"TIPS_BLISINTRO" => "The Laboratory Information Management System (LIMS) tracks patient specimens and laboratory results.", 
	...
	"lab_config_home" => array ( 
		...
		"TIPS_SETUPNETWORK_3" => "You will now be able to access LIMS by clicking on BlisSetup.html and entering your username and password.",
