...
function export_as_excel(div_id){
		$('#'+ div_id).table2excel({
			...
			filename: "Report daily patient barcodes",
			fileext: ".xls",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true
...
&nbsp;&nbsp;&nbsp;&nbsp;
<input type='button' onclick="javascript:export_as_excel('export_content');" value='<?php echo "Export as Excel" ?>'></input>
&nbsp;&nbsp;&nbsp;&nbsp;
...
<br/><br/>
<table style="border='0'" border="0" id="bcodetb" name="bcodetb">
