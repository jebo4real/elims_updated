...
function export_as_excel(div_id){
		$('#'+div_id).table2excel({
			...
			filename: "Report daily patients",
			fileext: ".xls",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true
...
<form name='word_format_form' id='word_format_form' action='export_word.php' method='post' target='_blank'>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<input type='button' onclick="javascript:export_as_excel('report_content');" value='<?php echo LangUtil::$generalTerms['CMD_EXPORTWORD']; ?>'></input>
	&nbsp;&nbsp;&nbsp;&nbsp;
