...
$(document).ready(function(){
	...
	//load data table for billing report
	$('#bill_tb').DataTable({
	"destroy": true,
	"dom": 'Bfrtip',
	"buttons": [
...
<!--Table(DataTable) for billing report -->
...
<tbody>
	<?php
	//retriving aggregate billing information from patient, test_type, specimen, test_type_costs tables using join
	$date_from = $_POST['df'];
	$date_to = $_POST['dt'];
		if($date_from){
...
<tfoot>
	<tr>
		...
		<td></td>
		<td></td>
		<td>	<h4>Total Cost:<?php echo $amount; ?> </h4></td>
		<td></td>
	</tr>
</tfoot>
