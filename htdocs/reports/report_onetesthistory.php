...
<table class='no_border'>
	...
	<td>
	&nbsp;&nbsp;
	<input type='button' onclick="javascript:export_as_excel('report_word_content');" value='Export Excel Document' title='<?php echo "Export as excel"; ?>'></input>
	</td>
	<td>
	&nbsp;&nbsp;
