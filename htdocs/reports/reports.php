    ...
    <table name="page_panes" cellpadding="10px">
        <tr valign='top'>
                ...
                <ul>
                    ...
                    <?php } else { ?>
                        ...
                        { ?>
                            ...
                            <li class='menu_option' id='inv_menu'>
                							<a href='javascript:show_selection("inv");'>Inventory Report</a>
                						</li>
                						<li class='menu_option' id='inv_menu'>
                							<a href='javascript:show_selection("bill");'>Billing Report</a>
                						</li>
                        <?php } ?>
            ...
            <td id="right_pane" class="right_pane" valign='top'>
                ...
                <!-- including date selection from for inventory report -->
                <?php include "inventory_in.php"; ?>

                <!--including date selection from for billing report -->
                <?php include "billing_in.php"; ?>
