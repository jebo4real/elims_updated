...
function export_as_excel(div_id){
		$('#'+div_id).table2excel({
			...
			filename: "Report selected tests",
			fileext: ".xls",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true
...
<table class='no_border'>
	...
	<td>
	&nbsp;&nbsp;
	<input type='button' onclick="javascript:export_as_excel('report_word_content');" value='Export Excel Document' title='<?php echo LangUtil::$generalTerms['CMD_EXPORTWORD']; ?>'></input>
	</td>
	<td>
	&nbsp;&nbsp;
