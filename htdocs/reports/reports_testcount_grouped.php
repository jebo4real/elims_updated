...
function export_as_excel(){
		$('#report_content').table2excel({
			exclude: ".noExl",
			name: "Excel Document Name",
			filename: "Report Test Count",
			fileext: ".xls",
			exclude_img: true,
			exclude_links: true,
			exclude_inputs: true
...
<form name='word_format_form' id='word_format_form' action='export_word.php' method='post' target='_blank'>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
  <!--export to excel button calling the export_as_excel javascript function-->
  <input type='button' onclick="javascript:export_as_excel();" value='<?php echo "Export as Excel Document"; ?>'></input>
	&nbsp;&nbsp;&nbsp;&nbsp;
