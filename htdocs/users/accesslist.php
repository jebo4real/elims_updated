...
'lab_user_new.php', 'lab_user_type_new.php', 'reports_userlog.php', 'lab_user_edit.php','lab_user_type_edit.php', 'ofield_update.php', 'doctor_ofield_update.php', 'search_config_update.php', 'cfield_new.php', 'cfield_edit.php');
...
'stock_management.php', 'stock_edit.php', 'lab_user_new.php', 'lab_user_type_new.php', 'reports_userlog.php', 'lab_user_edit.php', 'lab_user_type_edit.php', 'ofield_update.php', 'doctor_ofield_update.php','search_config_update.php', 'cfield_new.php', 'cfield_edit.php');
