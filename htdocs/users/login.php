...
$login_tip="If you have forgotten your password then please send an email to 'pboakye@koachie.org' with the subject 'Password'.<br> New password will be sent to you.";
